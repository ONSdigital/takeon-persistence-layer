...
public class ContributorEntityShort {
    ...
    public static class Builder {
        ...
        public ContributorEntityShort build() {
            return new ContributorEntityShort(this);
        }
    }

    private ContributorEntityShort (Builder builder) {
